...
<template>
  ...
  >
    <div
      class="flex items-center w-[180px] shrink-0 text-sky-800 font-semibold"
    >
      {{ appointment.appointment_date }}
    </div>
    <div class="flex items-center w-[230px] shrink-0 font-semibold">
      {{ formattedTime }}
    </div>
    <div class="flex items-center w-[200px] shrink-0">
      {{ appointment.name }}
    </div>
    <div
      class="flex items-center w-[180px] shrink-0 font-semibold text-sky-800"
    >
    ...
    <div class="flex-1 flex flex-row items-start justify-end">
      <div class="rounded flex flex-row items-center justify-center">
        <div class="mt-[-10px]">
          <v-dialog width="500">
            ...
            <template v-slot:default="{ isActive }">
              <v-card title="Zakończ wizytę">
                <v-card-text>
                  Chcesz oznaczyć wizytę jako zakończoną?
                </v-card-text>
                <v-card-actions>
                  <v-spacer></v-spacer>
        ...
        <ButtonItem type="tertiary" @click="onClick">Edytuj wizytę</ButtonItem>
      </div>
    </div>
  </div>
</template>
